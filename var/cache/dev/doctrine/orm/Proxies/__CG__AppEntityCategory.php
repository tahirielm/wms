...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCreatedAt(\DateTimeImmutable $createdAt): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function setUpdatedAt(\DateTimeImmutable $updatedAt): \App\Entity\Category
    {
