 ...
 */
class getReceivalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReceivalRepository' shared autowired service.
     *
     * @return \App\Repository\ReceivalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReceivalRepository.php';

        return $container->privates['App\\Repository\\ReceivalRepository'] = new \App\Repository\ReceivalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
