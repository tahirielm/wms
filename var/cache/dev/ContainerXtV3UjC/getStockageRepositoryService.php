 ...
 */
class getStockageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StockageRepository' shared autowired service.
     *
     * @return \App\Repository\StockageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StockageRepository.php';

        return $container->privates['App\\Repository\\StockageRepository'] = new \App\Repository\StockageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
