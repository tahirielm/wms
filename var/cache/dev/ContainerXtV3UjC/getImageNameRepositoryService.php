 ...
 */
class getImageNameRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ImageNameRepository' shared autowired service.
     *
     * @return \App\Repository\ImageNameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ImageNameRepository.php';

        return $container->privates['App\\Repository\\ImageNameRepository'] = new \App\Repository\ImageNameRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
