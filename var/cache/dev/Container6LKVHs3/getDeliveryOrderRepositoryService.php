 ...
 */
class getDeliveryOrderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveryOrderRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveryOrderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryOrderRepository.php';

        return $container->privates['App\\Repository\\DeliveryOrderRepository'] = new \App\Repository\DeliveryOrderRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
