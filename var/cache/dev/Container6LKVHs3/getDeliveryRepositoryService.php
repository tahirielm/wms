 ...
 */
class getDeliveryRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveryRepository.php';

        return $container->privates['App\\Repository\\DeliveryRepository'] = new \App\Repository\DeliveryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
