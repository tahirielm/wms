...
class __TwigTemplate_c15bfafde62b14de5211197dce9754be extends Template
{
    private $source;
    private $macros = [];
   ...
   <div class=\"col-md-6 mx-auto text-center\">
      ...
      <img src=\"";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 9, $this->source); })()), "user", [], "any", false, false, false, 9), "gravatar", [0 => 300], "method", false, false, false, 9), "html", null, true);
        echo "\" alt=\"Avatar ";
        ...
        echo "\" class=\"mt-5 rounded-circle\">
      <h2 class=\"mt-5\"> ";
        // line 10
        ...
        echo " </p>
                 <p><small>Account created at ";
        // line 14
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "user", [], "any", false, false, false, 14), "createdAt", [], "any", false, false, false, 14), "d/m/Y"), "html", null, true);
        echo " </small></p>
            <a href=\"";
        // line 15
...
";
    ...
    {
        return array (  115 => 15,  111 => 14,  107 => 13,  99 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"row\">
   <div class=\"col-md-6 mx-auto text-center\">
      <h1>Profile</h1>
      <img src=\"{{ app.user.gravatar(300) }}\" alt=\"Avatar {{ app.user.userName }}\" class=\"mt-5 rounded-circle\">
      <h2 class=\"mt-5\"> {{ app.user.firstName }} {{ app.user.lastName }} </h2>
      

            <p class=\"lead\"> {{ app.user.email }} </p>
                 <p><small>Account created at {{ app.user.createdAt|date('d/m/Y') }} </small></p>
            <a href=\"{{  path('app_profile_edit')}}\"> Edit Profile </a>

    </div>
</div>
{% endblock %}
", "profile/show.html.twig", "C:\\wamp64\\www\\dwira_blanca_app\\templates\\profile\\show.html.twig");
    }
}
