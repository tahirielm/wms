...
class __TwigTemplate_b7e9c3b232a28bcbe14358cae72e7661 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "lastName", [], "any", false, false, false, 16), 'row');
        echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t\t";
...
\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-lg\">Apply changes
\t\t\t</button>
\t\t\t";
        // line 23
...
";
    ...
    {
        return array (  119 => 23,  112 => 19,  106 => 16,  100 => 13,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "profile/edit.html.twig", "C:\\wamp64\\www\\wms\\templates\\profile\\edit.html.twig");
    }
}
